...
const Hero: React.FC = memo(() => {
  ...
  // Memoize floating animation variants
  ...
  return (
    <section 
      id="home" 
      className="min-h-screen relative overflow-hidden bg-gradient-to-br from-pastel-lavender/20 via-pastel-peach/10 to-pastel-cream/20 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900/50"
    >
      {/* Background Pattern */}
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -inset-6 border border-pastel-lavender/20 dark:border-purple-400/30 rounded-full"
              />
              <motion.div
                animate={{ rotate: -360 }}
                transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
                className="absolute -inset-8 border border-pastel-pink/15 dark:border-pink-400/25 rounded-full"
              />
              ...
              <motion.div
                ...
                className="absolute -top-2 -right-2 w-10 h-10 bg-gradient-to-r from-pastel-orange to-pastel-peach dark:from-orange-500 dark:to-pink-500 rounded-lg flex items-center justify-center shadow-lg"
              >
                <Rocket className="w-5 h-5 text-white" />
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -bottom-2 -left-2 w-10 h-10 bg-gradient-to-r from-pastel-cream to-pastel-pink dark:from-yellow-500 dark:to-pink-500 rounded-lg flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute top-1/2 -right-6 w-8 h-8 bg-gradient-to-r from-pastel-lavender to-pastel-pink dark:from-purple-500 dark:to-pink-500 rounded-lg flex items-center justify-center shadow-lg"
              >
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <motion.div
            ...
            className="w-8 h-8 border-2 border-pastel-lavender dark:border-purple-400 rounded-full flex items-center justify-center group-hover:border-pastel-pink dark:group-hover:border-pink-400 transition-colors"
          >
