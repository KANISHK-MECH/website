/*
  # Restore Sample Portfolio Data

  1. Sample Data
    - Restore initial internships data
    - Restore initial achievements data
    - Restore initial certifications data
    - Restore initial projects data

  2. Notes
    - Uses gen_random_uuid() for proper UUID generation
    - Includes all portfolio content
    - Safe to run multiple times (uses INSERT with conflict handling)
*/

-- Insert initial internships (with conflict handling)
