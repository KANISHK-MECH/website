/*
  # Add Initial Portfolio Data

  1. New Data
    - Initial internships with proper UUID generation
    - Initial achievements with proper UUID generation
    - All data uses gen_random_uuid() for proper UUID format

  2. Data Added
    - 4 internship experiences from various companies
    - 6 achievements including certifications, publications, and competition results
*/
